...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        module2_out, module2_cache = affine_relu_forward(module1_out.reshape(X.shape[0],-1), W2, b2)
        ...
        dx1, grads['W1'], grads['b1'] = conv_relu_pool_backward(dx2.reshape((X.shape[0],W1.shape[0],X.shape[2]//2,X.shape[3]//2)), module1_cache)
        pass
